...
static char *fonts[]          = { "Hack:size=9:antialias=true:autohint=true", "JoyPixels:pixelsize=9:antialias=true:autohint=true"};
...
/* tagging */
static const char *tags[] = { " cli", " web", " rem", " pass", " mus", " telegram", " cloud", " mail", " misc" };
